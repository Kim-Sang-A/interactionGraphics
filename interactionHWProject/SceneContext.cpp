...
namespace
{
	...
	const char * SAMPLE_FILENAME = "file.fbx";
...
bool SceneContext::OnDisplay()
{
	...
	//glutSolidCube(0.8);
	MyModuleRendering * hwmodule=new MyModuleRendering();
	//hwmodule->HWModuleRendering();

	glTranslatef(10.0,10.0,0.0);
	glRotatef(90.0f, 0.0f,1.0f,0.0f);

	hwmodule->MakeGeometry();
	hwmodule->~MyModuleRendering();
